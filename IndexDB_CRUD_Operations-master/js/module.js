...
const SortObj = (sortobj) => {
  ...
  obj = {
    id: sortobj.id,
    pictureone: sortobj.pictureone,
    nazvanie: sortobj.nazvanie,
    format: sortobj.format,
    datasozdania: sortobj.datasozdania,
    razmer: sortobj.razmer,
    ves: sortobj.ves,
    mimetype: sortobj.mimetype,
    opisanie: sortobj.opisanie,
